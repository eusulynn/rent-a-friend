...
louisc = Friend.create(name: "Louis Clermont", age: 32, gender: "Male", location: "Ghent, Belgium", price: rand(10..45), language: "French", user_id: 2, description: "I'm a student in Business and Finance at Bayes Business School. I just finished an internship of 3 months in a PE fund. I'm currently creating my own startup.")
...
salim = Friend.create(name: "Salim Saadi", age: 39, gender: "Male", location: "Croydon, London", price: rand(10..45), language: "French", user_id: 2, description: "I have recently moved to London to seek out new challenges and broaden my skill set. As part of this endeavour, I am currently enrolled in web development courses.")
...
warren = Friend.create(name: "Warren Wisbeach", age: 41, gender: "Male", location: "Cape Town, South Africa", price: rand(10..45), language: "English", user_id: 2, description: "I'm on an exciting journey to change careers and am really looking forward to joining Le Wagon's latest Web Development Bootcamp.")
...
justin = Friend.create(name: "Ling Fung Chan", age: 27, gender: "Male", location: "Hong Kong Island, Hong Kong", price: rand(10..45), language: "Cantonese", user_id: 2, description: "I am Justin from Hong Kong. A Biological Science graduate, former marketer and graphic designer. Love and enjoy coding : )")
justin.photo.attach(io: File.open('app/assets/images/avatars/Justin.jpeg'), filename: "Justin.jpeg", content_type: "image/jpeg")

louise = Friend.create(name: "Louise Stone", age: 31, gender: "Female", location: "Acton, London", price: rand(10..45), language: "English", user_id: 2, description: "👋 I'm a #1052 batch web dev graduate and currently a TA in the London HQ.")
louise.photo.attach(io: File.open('app/assets/images/avatars/Louise.jpeg'), filename: "Louise.jpeg", content_type: "image/jpeg")

zhanna = Friend.create(name: "Zhanna Doronina", age: 28, gender: "Female", location: "Enfield, London", price: rand(10..45), language: "Russian", user_id: 2, description: "Former Marketing Manager and Freelancer, now a TA and a junior Full-stack Developer. I genuinely enjoy coding, tackling challenges and learning new things on a daily basis. Happy to meet everyone and share this journey into Tech!")
zhanna.photo.attach(io: File.open('app/assets/images/avatars/Zhanna.jpeg'), filename: "Zhanna.jpeg", content_type: "image/jpeg")

tom = Friend.create(name: "Tom Duchambon", age: 29, gender: "Male", location: "Lyon, France", price: rand(10..45), language: "French", user_id: 2, description: "Former Marketing Manager and Freelancer, now a TA and a junior Full-stack Developer. I genuinely enjoy coding, tackling challenges and learning new things on a daily basis. Happy to meet everyone and share this journey into Tech!")
